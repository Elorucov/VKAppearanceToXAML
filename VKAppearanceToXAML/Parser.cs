...
namespace VKAppearanceToXAML {
    ...
    public class Parser {
        private static string GetHeader() {
            ...
            return $"<!-- This resource dictionary file generated by VKAppearanceToXAML tool by ELOR on {y}/{a}/{d}. -->";
        }
        ...
        private static string ParseScheme(JObject scheme) {
            ...
            foreach(var sk in scheme) {
                ...
                string op = opacity != 0 ? $" Opacity=\"{opacity.ToString(CultureInfo.InvariantCulture)}\"" : String.Empty;
                xaml += $"            <SolidColorBrush x:Key=\"{JSONKeyToXAMLStyle(sk.Key, "Brush")}\" Color=\"{{StaticResource {JSONKeyToXAMLStyle(sk.Value.Value<string>("color_identifier"), "Color")}}}\"{op}/>\n";
            }
